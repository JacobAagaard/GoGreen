...
class ReceiptDao {
  ...
  Future insertFakeReceipt() async {
    await _receiptFolder.addAll(await _db, fakeData.map((receipt)=>receipt.toMap()).toList());
...
final fakeVegetables = new ReceiptItem(emission: 1, quantity: 2, foodType: "vegetables");
final fakeChicken = new ReceiptItem(emission: 5, quantity: 1, foodType: "chicken");
final fakeRice = new ReceiptItem(emission: 4, quantity: 1, foodType: "rice");

final fakeData = [
  new Receipt(timestamp: DateTime(2020, 4), items: [fakeBeef,fakeChicken,fakeRice, fakeVegetables], totalEmission: 50),
  new Receipt(timestamp: DateTime(2020, 4), items: [fakeBeef,fakeRice, fakeVegetables], totalEmission: 45),
  new Receipt(timestamp: DateTime(2020, 3), items: [fakeBeef,fakeChicken, fakeVegetables], totalEmission: 46),
  new Receipt(timestamp: DateTime(2020, 3), items: [fakeBeef,fakeRice, fakeVegetables], totalEmission: 45),
  new Receipt(timestamp: DateTime(2020, 2), items: [fakeChicken,fakeRice, fakeVegetables], totalEmission: 10),
  new Receipt(timestamp: DateTime(2020, 2), items: [fakeBeef,fakeChicken], totalEmission: 45),
  new Receipt(timestamp: DateTime(2020, 1), items: [fakeChicken,fakeRice], totalEmission: 9),
  new Receipt(timestamp: DateTime(2020, 1), items: [fakeBeef,fakeRice], totalEmission: 44),
];
